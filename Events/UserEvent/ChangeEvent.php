...
class ChangeEvent extends UserEvent{
	...
	public function getClassName(){return "RuntimeUI.Events.UserEvent.ChangeEvent";}
	public static function getCurrentClassName(){return "RuntimeUI.Events.UserEvent.ChangeEvent";}
