...
class FocusEvent extends UserEvent{
	const ES6_EVENT_NAME = "focus";
	/* ======================= Class Init Functions ======================= */
	public function getClassName(){return "RuntimeUI.Events.UserEvent.FocusEvent";}
	public static function getCurrentClassName(){return "RuntimeUI.Events.UserEvent.FocusEvent";}
