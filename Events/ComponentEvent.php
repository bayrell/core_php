...
use RuntimeUI\Events\CommandEvent;
class ComponentEvent extends CommandEvent{
	...
	public function getClassName(){return "RuntimeUI.Events.ComponentEvent";}
	public static function getCurrentClassName(){return "RuntimeUI.Events.ComponentEvent";}
	public static function getParentClassName(){return "RuntimeUI.Events.CommandEvent";}
