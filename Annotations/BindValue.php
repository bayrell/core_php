...
class BindValue extends ControllerAnnotation{
	...
	static function initController($manager, $annotation, $controller){
		...
		$controller->addSignalOut(static::onChangeValue($manager, $annotation, $controller), (new Vector())->push("RuntimeUI.Events.UserEvent.ChangeEvent"));
	}
	/**
	 * On change
	 */
	static function onChangeValue($manager, $annotation, $controller){
	...
	public function getClassName(){return "RuntimeUI.Annotations.BindValue";}
	public static function getCurrentClassName(){return "RuntimeUI.Annotations.BindValue";}
