...
class MouseContextMenuEvent extends MouseEvent{
	const ES6_EVENT_NAME = "contextmenu";
	/* ======================= Class Init Functions ======================= */
	public function getClassName(){return "Core.UI.Events.MouseEvent.MouseContextMenuEvent";}
	public static function getCurrentNamespace(){return "Core.UI.Events.MouseEvent";}
	public static function getCurrentClassName(){return "Core.UI.Events.MouseEvent.MouseContextMenuEvent";}
