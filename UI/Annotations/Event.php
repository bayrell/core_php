...
class Event extends AnnotationEvent{
	...
	static function onEvent($manager, $e){
		...
		$f = rtl::method($manager, $e->annotation->method_name);
		$f($e);
	}
	/**
	 * Add Emitter
	...
	public function getClassName(){return "Core.UI.Annotations.Event";}
	public static function getCurrentNamespace(){return "Core.UI.Annotations";}
	public static function getCurrentClassName(){return "Core.UI.Annotations.Event";}
