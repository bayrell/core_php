...
class BlurEvent extends UserEvent{
	...
	public function getClassName(){return "RuntimeUI.Events.UserEvent.BlurEvent";}
	public static function getCurrentClassName(){return "RuntimeUI.Events.UserEvent.BlurEvent";}
