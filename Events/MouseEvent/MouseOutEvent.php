...
class MouseOutEvent extends MouseEvent{
	...
	public function getClassName(){return "RuntimeUI.Events.MouseEvent.MouseOutEvent";}
	public static function getCurrentClassName(){return "RuntimeUI.Events.MouseEvent.MouseOutEvent";}
