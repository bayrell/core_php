...
class FocusEvent extends UserEvent{
	...
	public function getClassName(){return "Core.UI.Events.UserEvent.FocusEvent";}
	public static function getCurrentNamespace(){return "Core.UI.Events.UserEvent";}
	public static function getCurrentClassName(){return "Core.UI.Events.UserEvent.FocusEvent";}
