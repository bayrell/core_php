...
use Core\UI\Events\KeyboardEvent\KeyboardEvent;
class KeyPressEvent extends KeyboardEvent{
	const ES6_EVENT_NAME = "keypress";
	/* ======================= Class Init Functions ======================= */
	public function getClassName(){return "Core.UI.Events.KeyboardEvent.KeyPressEvent";}
	public static function getCurrentNamespace(){return "Core.UI.Events.KeyboardEvent";}
	public static function getCurrentClassName(){return "Core.UI.Events.KeyboardEvent.KeyPressEvent";}
	public static function getParentClassName(){return "Core.UI.Events.KeyboardEvent.KeyboardEvent";}
