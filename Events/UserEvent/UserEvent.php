...
class UserEvent extends CoreEvent{
	...
	public function getClassName(){return "RuntimeUI.Events.UserEvent.UserEvent";}
	public static function getCurrentClassName(){return "RuntimeUI.Events.UserEvent.UserEvent";}
